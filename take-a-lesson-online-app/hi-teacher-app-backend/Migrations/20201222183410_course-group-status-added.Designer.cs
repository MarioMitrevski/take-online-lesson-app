...
namespace hi_teacher_app_backend.Migrations
{
    ...
    [Migration("20201222183410_course-group-status-added")]
    partial class coursegroupstatusadded
    {
            ...
            modelBuilder.Entity("hi_teacher_app_backend.Models.CourseGroup", b =>
                {
                    ...
                    b.Property<string>("courseGroupStatus")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("hi_teacher_app_backend.Models.Course", b =>
                {
                    ...
                    b.HasOne("hi_teacher_app_backend.Models.Teacher", null)
                        .WithMany("Courses")
